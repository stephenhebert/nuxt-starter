...
/**
  ...
  * @variables - radius=rounded-xl,accentColor=blue,colorTemperature=zinc,spacing=2.5,scale=lg,inputShadow=shadow-md,baseColorShade=500,borderShadeLightMode=400,borderShadeDarkMode=400,inputMaxWidth=max-w-20em,tagRadius=rounded-full,swatchRadius=rounded-full
  * @theme - regenesis
  **/
...
const classes: Record<string, Record<string, boolean>> = {
  ...
  'family:box__decorator': {
    ...
    'bg-white': true,
    'ring-blue-400': true,
    // 'peer-checked:border-blue-500': true,
    'relative': true,
    'block': true,
    'text-xl': true,
    'w-1em': true,
    ...
    // 'dark:ring-offset-blue-400': true,
    // 'dark:peer-focus-visible:ring-1': true,
    // 'dark:peer-disabled:bg-zinc-600/50': true,
    // 'dark:peer-checked:bg-blue-800': true,
    // 'dark:peer-checked:text-blue-300': true,
  ...
  'family:text__inner': {
    ...
    'focus-within:!ring-blue-400': true,
    'focus-within:!border-blue-400': true,
  ...
  'family:dropdown__listitem': {
    ...
    'data-[is-active]:before:ring-blue-400': true,
  ...
  'family:dropdown__tagWrapper': {
    ...
    'data-[active-selection=true]:ring-blue-400': true
  },
  ...
  'family:dropdown__tag': {
    ...
    'group-data-[active-selection=true]/tag:bg-blue-300': true,
  ...
  'file__fileRemove': {
    ...
    'peer-data-[has-multiple]:text-blue-500': true,
  ...
  'form__messageLink': {
    ...
    'group-[]/summary:ring-blue-500': true
  },
  'month__input': {
    'appearance-none': true,
    '[color-scheme:light]': true,
  ...
  'range__input': {
    ...
    '[&::-webkit-slider-thumb]:bg-blue-500': true,
    ...
    '[&::-webkit-slider-thumb]:focus:!ring-blue-400': true,
    ...
    '[&::-moz-range-thumb]:bg-blue-500': true,
    ...
    '[&::-moz-range-thumb]:focus:!ring-blue-400': true,
  ...
  'select__option': {
    ...
    'dark:group-data-[multiple]:focus:bg-blue-700': true,
    'dark:group-data-[multiple]:checked:bg-blue-700': true
  },
  'select__prefixIcon': {
    'flex': true,
    'items-center': true,
  ...
  'toggle__track': {
    ...
    'shadow': true,
    'peer-focus-visible:ring-2': true,
    'peer-focus-visible:ring-blue-400': true,
  ...
  'togglebuttons__input': {
    ...
    'dark:text-blue-500': true,
    'aria-[pressed="true"]:bg-blue-500': true,
    ...
    'group-data-[vertical="false"]/options:group-first/option:aria-[pressed="true"]:border-l-blue-500': true,
    'group-data-[vertical="false"]/options:group-last/option:aria-[pressed="true"]:border-r-blue-500': true,
    'dark:group-data-[vertical="false"]/options:group-[]/option:aria-[pressed="true"]:border-x-blue-500': true,
    'dark:group-data-[vertical="false"]/options:group-first/option:aria-[pressed="true"]:border-l-blue-500': true,
    'dark:group-data-[vertical="false"]/options:group-last/option:aria-[pressed="true"]:border-r-blue-500': true,
    ...
    'group-data-[vertical="true"]/options:group-first/option:aria-[pressed="true"]:border-t-blue-500': true,
    'group-data-[vertical="true"]/options:group-last/option:aria-[pressed="true"]:border-b-blue-500': true,
    'dark:group-data-[vertical="true"]/options:group-[]/option:aria-[pressed="true"]:border-y-blue-500': true,
    'dark:group-data-[vertical="true"]/options:group-first/option:aria-[pressed="true"]:border-t-blue-500': true,
    'dark:group-data-[vertical="true"]/options:group-last/option:aria-[pressed="true"]:border-b-blue-500': true
  },
}
